    ...
    <table class="table table-bordered table-striped table-hover align-middle" id="studebtsTable" style="width:100%;">
      <thead class="table-dark">
        <tr>
          ...
          <th>Phone Number</th>
          <th>Image</th>
          <th>Graduates and Career Professionals</th>
          <th>Status</th>
          <th>Action</th>
        </tr>
      </thead>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" style="width:600px;">
    ...
    <div class="offcanvas-body">
      <form method="POST" id="insertForm">
        ...
        <div class="row mb-3">
          <div class="col">
            <label class="form-label">Old School ID</label>
            <input type="text" class="form-control" name="oldschoolid" placeholder="2022-2-2343">
          </div>
          <div class="col">
        ...
        <div class="mb-3">
          <label class="form-label">Graduates and Career Professionals</label>
          <select name="department" class="form-control">
            <option value="business">Business Management</option>
            <option value="engr">Engineering</option>
            <option value="medical">Health and Medical Fields </option>
            <option value="educ">Education </option>
            <option value="scosci">Social Sciences</option>
            <option value="arts">Creative Arts and Design </option>
            <option value="tourism">Hospitality and Tourism</option>
            <option value="argri">Agriculture and Environmental Studies</option>
            <option value="archi">Architecture and Urban Planning</option>
            <option value="media">Communications and Media</option>
        ...
        <label class="form-label">Status:</label>
          ...
          <label class="form-input-label">Active</label>
          &nbsp;
          <input type="radio" class="form-check-input" name="status" value="inactive">
          <label class="form-input-label">Inactive</label>
        </div>
        <div>
