...
<div class="sidebar">
  ...
  <div class="container">
    ...
    <table class="table table-bordered table-striped table-hover align-middle" id="facultyTable" style="width:100%;">
      ...
      <form method="POST" id="insertForm">
        ...
        <div class="row mb-3">
          ...
          <div class="col">
            ...
            <input type="text" class="form-control" name="position" placeholder="Example: Dean">
          </div>
        </div>
        ...
        <label class="form-label">Status:</label>
          ...
          &nbsp;
          <input type="radio" class="form-check-input" name="status" value="onleave">
          <label class="form-input-label">On Leave</label>
          &nbsp;
          <input type="radio" class="form-check-input" name="status" value="onsabbatical">
          <label class="form-input-label">On Sabbatical</label>
        </div>
        <div>
    ...
    <div class="offcanvas-body">
      <form method="POST" id="editForm">
        ...
        <div class="row mb-3">
          <label class="form-label">Upload Image</label>
          <div class="col-2">
            <img class="preview_img" src="images/default-avatar.png">
          </div>
          <div class="col-10">
            <div class="file-upload text-secondary">
              <input type="file" class="image" name="image" accept="image/*">
        ...
        <div class="mb-3">
          <label class="form-label">Department</label>
          <select name="department" class="form-control">
            <option value="CAMS">Allied Medical Sciences [CAMS]</option>
